...
const galleryItems: GalleryItem[] = [
  {
    ...
    emoji: "🪩",
    description: "Arco di palloncini con scritta \"LA DISCO\" - festa danzante!",
    image: "/images/gallery/disco.jpeg",
  },
  {
    id: 2,
    category: "matrimoni",
    title: "Eleganza Pavone",
    gradient: "from-teal-400 to-blue-500",
    emoji: "🦚",
    description: "Decorazione elegante nei toni del blu e verde smeraldo",
  ...
  },
  {
    ...
    emoji: "✝️",
    description: "Bianco e oro per un giorno speciale - decorazione comunione",
  ...
  },
  {
    ...
    emoji: "❤️",
    description: "Romantico arco di cuori in palloncini per cerimonie",
    image: "/images/gallery/cuore.jpeg",
  },
  {
    id: 5,
    category: "feste",
    title: "Party Flamingo",
    gradient: "from-pink-400 to-rose-500",
    emoji: "🦩",
    description: "Atmosfera tropicale con flaminghi e colori pastello",
    image: "/images/gallery/flamingo.jpeg",
  },
  {
    id: 6,
    category: "comunioni",
    title: "Comunione con Cuori",
    gradient: "from-white to-amber-200",
    emoji: "💖",
    description: "Palloncini bianchi e dorati a forma di cuore",
  ...
  },
  {
    ...
    emoji: "👼",
    description: "Bianco e oro per accogliere un nuovo angioletto",
    image: "/images/gallery/battesimo.jpeg",
  },
  {
    id: 8,
    category: "feste",
    title: "Magia Unicorno",
    gradient: "from-violet-400 to-fuchsia-500",
    emoji: "🦄",
    description: "Colori pastello e magia per una festa da sogno",
...
const categories = [
  ...
  { id: "feste", label: "Feste", emoji: "🎉" },
  { id: "matrimoni", label: "Matrimoni", emoji: "💍" },
  { id: "comunioni", label: "Comunioni", emoji: "✝️" },
  { id: "battesimi", label: "Battesimi", emoji: "👼" },
];
