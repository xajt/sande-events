...
// Gallery data - only items with actual images
const galleryItems: GalleryItem[] = [
  // Popular Characters - Italian Market 2025/2026
  {
    id: 1,
    category: "postacie",
    title: "44 Gatti",
    ...
    emoji: "🐱",
    description: "Un successo italiano - Lampo, Milady, Pilou e Polpetta!",
    image: "/images/44-gatti.png",
  },
  {
    id: 2,
    category: "postacie",
    ...
    emoji: "🐰",
    description: "L'amato coniglietto Bing con i suoi amici",
  ...
  },
  {
    ...
    emoji: "🐱",
    description: "Gabby e Pandy Paws - successo Netflix!",
  ...
  },
  {
    ...
    emoji: "🐻",
    description: "Masha e Orso - un grande classico!",
...
const categories = [
  ...
  { id: "postacie", label: "Personaggi", emoji: "🌟" },
];
